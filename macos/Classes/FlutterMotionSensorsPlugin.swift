...
public class FlutterMotionSensorsPlugin: NSObject, FlutterPlugin {
    ...
    private var gyroscopeEventSink: FlutterEventSink?
    private var magnetometerEventSink: FlutterEventSink?
    private var motionEventSink: FlutterEventSink?
        ...
        case "getAllMotionSensorData":
            if motionManager.isDeviceMotionAvailable {
                ...
                motionManager.startDeviceMotionUpdates(to: .main) { [weak self] (motion, error) in
                    ...
                    let data: [String: Any] = [
                        "accelerometer": accelerometerData as Any,
                        "gyroscope": gyroscopeData as Any,
                        "magnetometer": nil,
                        "timestamp": timestamp
                    ]
                    capturedResult?(data)
                ...
                group.notify(queue: .main) {
                    let data: [String: Any] = [
                        "accelerometer": accelerometerData as Any,
                        "gyroscope": gyroscopeData as Any,
                        "magnetometer": magnetometerData as Any,
                        "timestamp": timestamp
                    ]
                    capturedResult?(data)
                    capturedResult = nil
